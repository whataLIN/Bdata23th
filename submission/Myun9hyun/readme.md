...
* 안녕하세요, 제 이름은 김명현입니다. 현재 프로그래밍을 공부하고 있으며, Python, Java, C++ 등 다양한 언어를 사용하기를 원합니다. Python을 가장 많이 사용하며, 이 언어로 웹 개발, 데이터 분석, 머신러닝 등의 프로젝트를 진행했으면 하는 소망을 가져도 되겠습니까? 또한, Visual Studio Code와 Eclipse 등의 개발 환경을 사용하며, Git을 활용한 버전 관리도 경험해봤습니다.
